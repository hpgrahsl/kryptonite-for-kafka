...
public enum SchemaMode {
    /**
     * Dynamic schema registration. The filter auto-derives and registers encrypted schemas
     * in Schema Registry on first encounter. SR read + write access required. Default.
     */
    DYNAMIC,
    /**
     * Static mapping. Operator pre-registers all encrypted schemas before the proxy starts.

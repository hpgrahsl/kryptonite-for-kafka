# Kryptonite for Kafka: Quarkus HTTP Service
...
### 👉 For the latest module documentation please go to the official docs page for the [Quarkus HTTP Service](https://hpgrahsl.github.io/kryptonite-for-kafka/dev/modules/funqy-http/) 👈
